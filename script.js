...
function formatPassiveText(text) {
    ...
    const processText = (text) => {
        ...
        processed = processed.replace(/(\d+)%↑/g, '$1% <img src="https://glben.dokkaninfo.com/assets/global/en/layout/en//image/ingame/battle/skill_dialog/passive_skill_dialog_arrow01.png" class="passive-arrow" alt="↑">');
        return processed;
    };
