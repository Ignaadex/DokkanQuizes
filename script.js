...
function formatPassiveText(text) {
    ...
    const imageReplacements = {
        '{passiveImg:up_g}': '<img src="https://github.com/Ignaadex/DokkanQuizes/blob/main/images/passive_skill_dialog_arrow01.png" class="passive-arrow" alt="↑">',
        '{passiveImg:down_y}': '<img src="https://github.com/Ignaadex/DokkanQuizes/blob/main/images/passive_skill_dialog_arrow03.png" class="passive-arrow" alt="↓">',
        '{passiveImg:once}': '<img src="https://github.com/Ignaadex/DokkanQuizes/blob/main/images/passive_skill_dialog_icon_01.png" class="passive-icon" alt="once">',
        '{passiveImg:forever}': '<img src="https://github.com/Ignaadex/DokkanQuizes/blob/main/images/passive_skill_dialog_icon_02.png" class="passive-icon" alt="forever">'
    };
    ...
    const processText = (text) => {
        ...
        processed = processed.replace(/(\d+)%↑/g, '$1% <img src="https://github.com/Ignaadex/DokkanQuizes/blob/main/images/passive_skill_dialog_arrow01.png" class="passive-arrow" alt="↑">');
        return processed;
    };
